...
[![](https://img.shields.io/badge/版本-3.9.0-java17-RC1-brightgreen.svg)](https://github.com/zuihou/lamp-cloud)
...
- 所涉及的相关的技术有：
    ...
    - 项目构建：Maven
    - 文件服务器：FastDFS 5.0.5/阿里云OSS/本地存储/MinIO/华为云OBS/七牛云OSS/本地存储
    - Nginx
- 部署方面：
    - 服务器：CentOS
    - Jenkins
